...
//    mutating func encodeIfPresent(_ value: [AnyHashable: Any]?, forKey key: KeyedEncodingContainer<K>.Key) throws {
...
//                try container.encodeIfPresent(val, forKey: JSONCodingKeys(stringValue: item.key as! String)!)
